...
public class Customer implements Comparable<Customer>
{
	...
	public String toString() 
	{
		...
		return "Customer [name=" + name + ", email=" + email + ", password=" + password + ", registrationAmount="
				+ registrationAmount + ", dob=" + sdf.format(dob) + ", plan=" + plan + ", adhaar=" + temp + "]";
	}

	public Adhaar getAdhaar() 
	{
		return this.adhaar;												//will return null or instance values if adhaar is linked
	}
	...
	{
		return (temp.email).compareTo(this.email);
	}
