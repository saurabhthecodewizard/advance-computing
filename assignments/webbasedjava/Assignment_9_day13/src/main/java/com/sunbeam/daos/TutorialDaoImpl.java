...
public class TutorialDaoImpl {
	...
	public int deleteById(int tutorialId) {
	...
	public int add(Tutorial tutorial) {
		...
		String sql = "INSERT INTO tutorials VALUES(default,?,?,?,?,?,?)";
		int count = jdbcTemplate.update(sql,tutorial.getName(), tutorial.getAuthor(), tutorial.getPublishDate(), tutorial.getVisits(), tutorial.getTopicId(), tutorial.getContents());
		return count;
	}
